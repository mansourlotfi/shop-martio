        ...
        <div className="row">
          <div className="col-12">
            <div className="e-filter-bar">
              <div className="e-filter-leftbar">
                <p className="e-filter-items">
                  نمایش موارد 1 از 12 در 40 در نتیجه
                </p>
              </div>
              <div className="e-filter-rightbar">
                <ul className="e-filter-list">
                  ...
                  <li>
                    <select>
                      <option>قیمت </option>
                      <option value="1">50000 تومان - 99000 تومان</option>
                      <option value="2">100000 تومان - 200000 تومان</option>
                      <option value="3">300000 تومان - 500000 تومان</option>
                      <option value="4">500000 تومان - 900000 تومان</option>
                    </select>
                  </li>
                  <li>
                    <select>
                      <option>مرتب سازی برا اساس </option>
                      <option value="1">محبوبت </option>
                      <option value="2">فروش برتر</option>
                      <option value="3">پر طرفدار</option>
                      <option value="4">اخیر</option>
                    </select>
                  </li>
                  <li>
                    <select>
                      <option>برند</option>
                      <option value="1">لویا</option>
                      <option value="2">گوساس</option>
                      <option value="3">لوکات</option>
                      <option value="4">اوجی</option>
                    </select>
                  </li>
                  <li>
                    <select>
            ...
            <div className="e-procategory-inner ">
              <ul>
                <li>
                        ...
                        <div className="na-top-sec text-center">
                          <div className="na-imgbox">
                            <div className="na-mainimg">
                              <img
                                src="assets/images/index1/new_arrivals/01.png"
                                alt="product-img"
                                className="img-fluid"
                              />
                            </div>
                            <div className="na-overlay-img">
                              <img
                                src="assets/images/index1/new_arrivals/11.png"
                                alt="product-img"
                                className="img-fluid"
                              />
                            </div>
                          </div>
                          <div className="na-color-details">
                      ...
                      <div className="c-product-box">
                        <div className="na-top-sec text-center">
                          <div className="na-imgbox">
                            <div className="na-mainimg">
                              <img
                                src="assets/images/index1/new_arrivals/02.png"
                                alt="product-img"
                                className="img-fluid"
                              />
                            </div>
                            <div className="na-overlay-img">
                              <img
                                src="assets/images/index1/new_arrivals/10.png"
                                alt="product-img"
                                className="img-fluid"
                              />
                            </div>
                      ...
                      <div className="c-product-box">
                        <div className="na-top-sec text-center">
                          <div className="na-imgbox">
                            <div className="na-mainimg">
                              <img
                                src="assets/images/index1/new_arrivals/03.png"
                                alt="product-img"
                                className="img-fluid"
                              />
                            </div>
                            <div className="na-overlay-img">
                              <img
                                src="assets/images/index1/new_arrivals/12.png"
                                alt="product-img"
                                className="img-fluid"
                              />
                            </div>
                      ...
                      <div className="c-product-box">
                        <div className="na-top-sec text-center">
                          <div className="na-imgbox">
                            <div className="na-mainimg">
                              <img
                                src="assets/images/index1/new_arrivals/04.png"
                                alt="product-img"
                                className="img-fluid"
                              />
                            </div>
                            <div className="na-overlay-img">
                              <img
                                src="assets/images/index1/new_arrivals/07.png"
                                alt="product-img"
                                className="img-fluid"
                              />
                            </div>
                      ...
                      <div className="c-product-box">
                        <div className="na-top-sec text-center">
                          <div className="na-imgbox">
                            <div className="na-mainimg">
                              <img
                                src="assets/images/index1/new_arrivals/05.png"
                                alt="product-img"
                                className="img-fluid"
                              />
                            </div>
                            <div className="na-overlay-img">
                              <img
                                src="assets/images/index1/new_arrivals/08.png"
                                alt="product-img"
                                className="img-fluid"
                              />
                            </div>
                      ...
                      <div className="c-product-box">
                        <div className="na-top-sec text-center">
                          <div className="na-imgbox">
                            <div className="na-mainimg">
                              <img
                                src="assets/images/index1/new_arrivals/06.png"
                                alt="product-img"
                                className="img-fluid"
                              />
                            </div>
                      ...
                      <div className="c-product-box">
                        <div className="na-top-sec text-center">
                          <div className="na-imgbox">
                            <div className="na-mainimg">
                              <img
                                src="assets/images/index1/new_arrivals/09.png"
                                alt="product-img"
                                className="img-fluid"
                              />
                            </div>
            ...
            <div className="e-pagination-wrap mt-10">
