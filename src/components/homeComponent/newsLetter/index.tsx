    ...
    <section className="e-newsletter-wrap e-newsletter-cloth">
      ...
      <div className="newletter-moving-wrap">
        <ul className="newletter-moving-list">
          <li>
            <img
              src="assets/images/index1/news_move1.png"
              alt="image"
              className="img-fluid"
            />
          </li>
          <li>
            <img
              src="assets/images/index1/news_move2.png"
              alt="image"
              className="img-fluid"
            />
          </li>
          <li>
            <img
              src="assets/images/index1/news_move3.png"
              alt="image"
              className="img-fluid"
            />
          </li>
          <li>
            <img
              src="assets/images/index1/news_move4.png"
              alt="image"
              className="img-fluid"
            />
          </li>
